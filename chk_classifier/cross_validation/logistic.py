...
for filename in filename_list:
    ...
    #metrics_dataframe.to_csv('result_a/logistic/logistic_' + filename + '.csv', index=False)
    ...
    kfold_data.to_csv('result_a/logistic/kfold_data_logistic_' + filename + '.csv', index=False)