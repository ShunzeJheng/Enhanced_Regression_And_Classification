...
for filename in filename_list:
    ...
    #metrics_dataframe.to_csv('result_a/LinearSVC/LinearSVC_' + filename + '.csv', index=False)
    ...
    kfold_data.to_csv('result_a/LinearSVC/kfold_data_LinearSVC_' + filename + '.csv', index=False)