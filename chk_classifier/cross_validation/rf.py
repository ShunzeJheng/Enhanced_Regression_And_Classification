...
for filename in filename_list:
    ...
    #metrics_dataframe.to_csv('result_a/rf/rf_' + filename + '.csv', index=False)
    ...
    kfold_data.to_csv('result_a/rf/kfold_data_rf_' + filename + '.csv', index=False)