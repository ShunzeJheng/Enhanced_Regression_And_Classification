...
def error_range(file):
    ...
    datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/chk_PCR/blended_vs_online_vs_offline/all_result_a/cross_validation_Residual_table_blended_' + file + '.csv', sep=',')
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/chk_PCR/blended_vs_online_vs_offline/all_result_a/error_table_' + file + '..csv', index=False)
    ...
    for data in features_val:
        ...
        result.append([data[0], data[1], data[2]**2, data[3], positive_error, negative_error, positive_error_rate, negative_error_rate])
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/chk_PCR/blended_vs_online_vs_offline/all_result_a/error_table_2_' + file + '..csv', index=False)