# coding: utf-8
#程式目的:高三增能A班資料集先使用resampling平衡資料集，然後使用7種分類演算法建立模型並加入投票機制
...
for oversampler_index in range(0,len(oversampler_name_list)):
    ...
    metrics_dataframe.to_csv('chka_result/voting_result_' + oversampler_name_list[oversampler_index] + '.csv', index=False)
