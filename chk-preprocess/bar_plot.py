...
dataset = pd.read_csv('result_b/ncu_data_week_1-6.csv', sep=',')

score_str = ['0-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-100']
score_num = []
for i in range(1,11):
    if i == 1:
