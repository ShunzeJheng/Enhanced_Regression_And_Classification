# coding: utf-8
#程式目的:輸出地科班資料集在不同參數下的Logistic模型對indicator的準確度
...
for filename in filename_list:
    ...
    if del_flag:
        metrics_dataframe.to_csv('classifier_result/logistic_result/logistic_result' + '_' + filename + '_delete.csv', index=False)
    else:
        metrics_dataframe.to_csv('classifier_result/logistic_result/logistic_result' + '_' + filename + '.csv', index=False)