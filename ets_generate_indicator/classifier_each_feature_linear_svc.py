# coding: utf-8
#程式目的:輸出地科班資料集在不同參數下的linear_svc模型對indicator的準確度
...
for filename in filename_list:
    ...
    for loss_type in loss_types:
        ...
        if del_flag:
            metrics_dataframe.to_csv('classifier_result/linear_svc_result/linear_svc_result_' + loss_type + '_' + filename + '_delete.csv', index=False)
        else:
            metrics_dataframe.to_csv('classifier_result/linear_svc_result/linear_svc_result_' + loss_type + '_' + filename + '.csv', index=False)