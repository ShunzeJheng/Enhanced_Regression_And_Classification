# coding: utf-8
#程式目的:輸出地科班資料集在不同參數下的svc模型對indicator的準確度
...
for filename in filename_list:
    ...
    for kernel_type in kernel_types:
        ...
        if del_flag:
            metrics_dataframe.to_csv('classifier_result/svc_result/svc_result_' + kernel_type + '_' + filename + '_delete.csv', index=False)
        else:
            metrics_dataframe.to_csv('classifier_result/svc_result/svc_result_' + kernel_type + '_' + filename + '.csv', index=False)