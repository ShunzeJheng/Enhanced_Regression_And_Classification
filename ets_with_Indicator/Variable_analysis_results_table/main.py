...
def Variable_analysis_results_table(file, index_min, features_begin_index, features_end_index, num_of_cluster):
    ...
    variable_analysis_results_table.to_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/Variable_analysis_results_table/result/' + file + '_best_comp_variable_analysis_results_table.csv', index=False)
