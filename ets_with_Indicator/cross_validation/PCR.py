...
def cross_validation(file, features_begin_index, features_end_index, num_of_cluster):
    ...
    for filename in filename_list:
        # 讀取資料並指定特徵與LABEL
        datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/data/ncu_data_week_' + filename + '.csv', sep=',')
        ...
        metrics_dataframe.to_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/cross_validation/result/PCR_metrics_list_' + file + '_normalize.csv', index=False)

        # 計算各項指標
        datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/cross_validation/result/PCR_metrics_list_' + file + '_normalize.csv', sep=',')
