...
def error_range(file):
    ...
    datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/blended_vs_online_vs_offline/result/cross_validation_Residual_table_blended_' + file + '.csv', sep=',')
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/blended_vs_online_vs_offline/result/error_table_' + file + '.csv', index=False)
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/blended_vs_online_vs_offline/result/error_table_2_' + file + '.csv', index=False)