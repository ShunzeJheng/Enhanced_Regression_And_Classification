...
for file in filename_list:
    ...
    datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/ets_with_Indicator/Variable_analysis_results_table/result/' + file + '_best_comp_variable_analysis_results_table.csv', sep=',')
    key_feature = []
    comp_header = []
