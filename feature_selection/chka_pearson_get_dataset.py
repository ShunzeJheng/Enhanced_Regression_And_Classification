# coding: utf-8
#程式目的:輸出高三增能A班資料集根據pearson係數與顯著性進行特徵選取的結果，並輸出資料集
...
for filename in filename_list:
    ...
    pearon_dataset = pd.read_csv('chka_result/correlation_' + filename + '.csv', sep=',')
    ...
    for i in range(0,len(feature_list)-1):
        ...
        metrics.to_csv('chka_result/ncu_data_week_' + filename + '.csv', index=False)
