...
datasets = pd.read_csv('result_a/cart/residual/cross_validation_Residual_table_' + week + '_normalize.csv', sep=',')
...
result.to_csv('result_a/cart/residual/error_table.csv', index=False)
...
result.to_csv('result_a/cart/residual/error_table_2.csv', index=False)