...
def error_range(file):
    ...
    datasets = pd.read_csv('C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/cross_validation_Residual_table_blended_' + file + '.csv', sep=',')

    features_header = list(datasets)[0:5]
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/error_table_' + file + '.csv', index=False)
    ...
    for data in features_val:
        ...
        if error >= 0:
            ...
            positive_error_rate = positive_error / data[4]
        else:
            negative_error = error
            negative_error_rate = negative_error / data[4]
    ...
    result.to_csv('C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/error_table_2_' + file + '.csv', index=False)
error_range("1-18(3a)")