...
def blended_vs_online_vs_offline(file, key_feature):
    ...
    # 指定輸出路徑
    output_path_acc = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/PCR_blended_' + datasets_small_name + '.csv'
    output_path_residual = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/cross_validation_Residual_table_blended_' + datasets_small_name + '.csv'
    output_path_after_pca = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/data_after_pca_blended_' + datasets_small_name + '.csv'
    output_path_mlr_coef = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/MLR_coef_blended_' + datasets_small_name + '.csv'
    output_path_data_with_predict = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/data_with_predict_blended_' + datasets_small_name + '.csv'
    output_path_data_standard = 'C:/Users/kslab/PycharmProjects/ets_PCR/blended_vs_online_vs_offline/result/data_with_standard_' + datasets_small_name + '.csv'
    ...
    OLS_Regression(output_path_acc, total_features, features_val, label_val, 'blended')
    # 輸出經過pca轉換後的資料集
