...
def blended_vs_online_vs_offline(file, key_feature, num_of_cluster):
    ...
    # 指定輸出路徑
    output_path_acc = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/PCR_blended_' + file + '.csv'
    output_path_residual = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/cross_validation_Residual_table_blended_' + file + '.csv'
    output_path_after_pca = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/data_after_pca_blended_' + file + '.csv'
    output_path_mlr_coef = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/MLR_coef_blended_' + file + '.csv'
    output_path_data_with_predict = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/data_with_predict_blended_' + file + '.csv'
    output_path_data_standard = 'C:/Users/kslab/PycharmProjects/chk_with_indicator/blended_vs_online_vs_offline/all_result_a/data_with_standard_' + file + '.csv'
