...
for filename in filename_list:
    ...
    #metrics_dataframe.to_csv('result/GaNB/GaNB_' + filename + '.csv', index=False)
    ...
    kfold_data.to_csv('result/GaNB/kfold_data_GaNB_' + filename + '.csv', index=False)