...
for filename in filename_list:
    ...
    #metrics_dataframe.to_csv('result/logistic/logistic_' + filename + '.csv', index=False)
    ...
    kfold_data.to_csv('result/logistic/kfold_data_logistic_' + filename + '.csv', index=False)
